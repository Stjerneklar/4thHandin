...
namespace _4thHandin
{
    public partial class Browse : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                LiteralHtmlInjector.Text = FourthProjectLogic.Movie.RenderPosters("Genre", "Action");
            }
            else //use querystring
            {
                LiteralHtmlInjector.Text = FourthProjectLogic.Movie.RenderPosters("Genre", Request.QueryString["genre"]); 
            }
        }
